...
int currposPrecCreditClass = 0;//vị trí hiện tại 
int currposCreditClass = 0;// cũng là vị trí hiện tại
//hàm kiểm tra
...
int FindCreditClassWithIdSubject(PTR_LISTCREDITCLASS l, string idSubject)
{
	if (l->n < 0) return NULL;
	for (int i = 0; i <= l->n; i++)
	{
...
PTR_CREDITCLASS FindCrediClassWithCondition(PTR_LISTCREDITCLASS l, string idSubject, int shoolYear, int semester, int group)
{
